...
func BresenhamLoS(start, end Point, canPass func(x, y int) bool) []Point {
    var los []Point
...
func Bresenham(start_x int, start_y int, end_x int, end_y int, traverse func(x int, y int) bool) {
